...
ENV PG_VERSION 10.7-1.pgdg100+1
...
# see note below about "*.pyc" files
	...
	aptRepo="[ signed-by=/usr/local/share/keyrings/postgres.gpg.asc ] https://apt-archive.postgresql.org/pub/repos/apt/ buster-pgdg-archive main"; \
	case "$dpkgArch" in \
